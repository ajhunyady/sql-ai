...
<div class="flex items-start">
  <div
    class="w-10 h-10 rounded-xl mr-4 mt-1 bg-gradient-to-br from-dark-blue-600 to-dark-blue-800 flex items-center justify-center border-2 border-dark-blue-500/30"
  >
  ...
  <div class="flex-1">
    <div class="backdrop-blur-xl bg-slate-950/80 rounded-xl p-5 border border-dark-blue-500/30">
      ...
      <div class="overflow-x-auto mb-6">
        <table
          class="min-w-full bg-slate-900/50 border border-dark-blue-500/30 rounded-xl overflow-hidden"
        >
          <thead>
            <tr class="bg-gradient-to-r from-dark-blue-600/20 to-dark-blue-800/20">
              <th
                class="px-6 py-4 border-b border-dark-blue-500/30 text-left font-semibold text-slate-200"
                >Customer</th
              >
              <th
                class="px-6 py-4 border-b border-dark-blue-500/30 text-right font-semibold text-slate-200"
                >Revenue</th
              >
              <th
                class="px-6 py-4 border-b border-dark-blue-500/30 text-right font-semibold text-slate-200"
          ...
          <tbody>
            <tr class="hover:bg-dark-blue-500/10 transition-colors duration-300">
      ...
      <div class="bg-slate-900/50 p-5 rounded-xl border border-dark-blue-500/30">
        <div
          class="bg-gradient-to-r from-dark-blue-600/20 to-dark-blue-800/20 text-slate-300 p-3 rounded-lg mb-3 text-sm flex items-center"
        >
          <i class="fa-solid fa-code mr-2 text-dark-blue-400"></i>
...
LIMIT 5;</pre>
    ...
    <div class="flex items-center mt-3 space-x-6">
      ...
      <div class="flex space-x-3">
        ...
        <button
          class="text-slate-400 hover:text-dark-blue-400 transition-colors duration-300"
          aria-label="Share"
        >
